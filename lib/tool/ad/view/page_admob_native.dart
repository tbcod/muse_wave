...
//   @override
//   void onReady() {
//     AdUtils.instance.loadPageNativeAd(AdPosId.nvpage_full.name, adSense: AdScene.play).then((v) {
//       NativeAd? ad = AdUtils.instance.getPageNativeAd(AdPosId.nvpage_full.name, adSense: AdScene.play);
//       if (ad != null) {
//         EventUtils.instance.addEvent("ad_onshow", data: {"ad_format": "${AdPosId.nvpage_full.name}_native", "ad_sense": AdScene.play.name, "ad_pos_id": AdPosId.nvpage_full.name, "ad_id": ad.adUnitId, "ad_source_client": "admob", "ad_type": "native"});
//         admobAd = ad;
